...
var Menu = function (_Phaser$State) {
	...
	_createClass(Menu, [{
		...
		value: function create() {
			...
			this.btnReplay = this.add.button(this.game.world.centerX, this.game.world.centerY + 200, _customConfig2.default.replay.key, this.startGame, this);
...
var Play = function (_Phaser$State) {
	...
	_createClass(Play, [{
		...
		value: function update() {
			...
			/*
   this.game.physics.arcade.collide(this.player.playerBody, this.ground, this.player.playerBodyHitGround, null, this);
   this.game.physics.arcade.collide(this.player.playerBullet, this.enemy.enemyBody, this.player.playerBulletHitEnemy, null, this);
   this.game.physics.arcade.collide(this.player.playerBullet, this.ground, this.player.playerBulletHitGround, null, this);
   //this.player.update();
   */
		}
	}]);
...
var Preload = function (_Phaser$State) {
	...
	_createClass(Preload, [{
		...
		value: function preload() {
			...
			this.preloadSprite = this.add.sprite(this.game.world.centerX, this.game.world.centerY, _customConfig2.default.go.key);
