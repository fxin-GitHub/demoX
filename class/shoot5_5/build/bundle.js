...
var Play = function (_Phaser$State) {
	...
	_createClass(Play, [{
		...
		value: function create() {
			...
			this.setEnemyTreeX();
			this.player = new _player2.default(this.game, this.game.width * 0.25, this.game.world.centerY, null, this.ground);
		...
		value: function setEnemyTreeX() {
			if (_customConfig2.default.common.enemyTreeX + 250 > this.game.camera.width * 0.75) {
			...
			} else if (_customConfig2.default.common.enemyTreeX + 250 <= this.game.camera.width * 0.75) {
				_customConfig2.default.common.enemyTreeX += 250;
		...
		value: function render() {
			...
			this.game.debug.text(this.enemy.launchSpeed, 20, 40);
			this.game.debug.text(_customConfig2.default.flag.emergency, 20, 60);
		}
	}]);
