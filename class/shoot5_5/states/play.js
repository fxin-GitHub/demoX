...
class Play extends Phaser.State{
	create(){		
	    ...
	    this.setEnemyTreeX();
	    this.player = new Player(this.game, this.game.width*0.25, this.game.world.centerY,null, this.ground);
    ...
    setEnemyTreeX(){
    	if(customConfig.common.enemyTreeX+250 > this.game.camera.width*0.75){
	...
	render(){
		...
		this.game.debug.text(customConfig.flag.emergency, 20, 60);
	}
}
